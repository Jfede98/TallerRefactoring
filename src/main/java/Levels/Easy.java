...
import com.pooespol.proyectodiscreta.PaginaFacilController;
...
public class Easy {
    ...
    public static boolean isInsideLeft(double x, double y) {
    ...
    public static boolean isInsideRight(double x, double y) {
